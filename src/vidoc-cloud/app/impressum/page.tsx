            ...
            <div className="bg-white">
                ...
                <div className="mx-auto py-6 max-w-5xl px-2 sm:px-6 lg:px-8 h-16">
                    <div className="pt-32">
                        ...
                        <p className="mt-2">
                            This website is owned by Henry Müssemann. It offers
                            a free-to-use cloud implementation for Vidoc, a
                            free-to-install extension for various IDEs. The
                            content of our website has been compiled with
                        ...
                        <p className="mt-2">
                            ...
                            sets out how we will treat your personal
                            information.
                        </p>
                        ...
                        <p className="mt-2">
                            ...
                            As the content of these external websites is not
                            under our control, we cannot assume any liability
                            for such external content. In all cases, the
                            provider of information of the linked websites is
                            liable for the content and accuracy of the
