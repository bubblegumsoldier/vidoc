                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          <p className="text-sm text-gray-500">
                            Are you sure you want to schedule this project for
                            deletion? All data will be permanently removed
                            within 30 days. This action cannot be undone. Your
                            current Vidocs will not be available under the same
                            URLs as now. You can however back up your Vidocs and
                            re-upload them to a new project or in your personal
                            storage location. Please contact us if you need help
                            with this process.
                          </p>
                        </div>
                      </div>
